...
const PrivacyPolicyModal = () => <div data-testid="div">lol</div>;
...
//       <button onClick={onAccept} className={styles.closeButton}>
//         <span className="visually-hidden">Zamknij komunikat i zaakceptuj politykę prywatności</span>
//         <svg
//           aria-hidden="true"
//           width="20"
//           height="20"
